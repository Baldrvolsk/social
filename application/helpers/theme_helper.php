...
if (!function_exists('build_path')) {
    ...
    function build_path() {
        ...
        if (!empty($args = func_get_args())) {
            ...
            return implode(DIRECTORY_SEPARATOR, array_map('rtrim', $args, array(DIRECTORY_SEPARATOR))) .
                DIRECTORY_SEPARATOR;
        }
...
if (!function_exists('img_alt')) {
    ...
    function img_alt($width, $height = null, $text = null, $background = null, $foreground = null) {
        ...
        return '<img src="http://placehold.it/' . $params['width'] . 'x' . $params['height'] . '/' .
