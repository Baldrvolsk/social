...
$config['admin_group'] = array('moderator', 'admin', 'sup_admin', 'owner'); // Default administrators group, use name
...
$config['user_expire']                = 86500;               // How long to remember the user (seconds). Set to zero
// for no expiration
